-- Description: This file contains the SQL script to create the database schema.
-- It creates the tables for the users, repositories, issues, projects, pullrequests, and projectcards.
